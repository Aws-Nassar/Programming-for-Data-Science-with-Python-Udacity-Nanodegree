...
## Features
- Analyze bikeshare data from major cities (currently supports Chicago, New York City, and Washington).
- Generate statistics for user types, travel times, and popular routes.
- Filter data by month, day, or both for customized analysis.
